  ...
  return (
    <div className="bg-card rounded-xl border border-border overflow-hidden">
      ...
      <div className="p-4 border-b border-border">
        <h3 className="text-lg font-bold text-foreground">Gửi Ticket Hỗ Trợ</h3>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                <div className={`p-2 rounded-lg ${currentType.bgColor}`}>
                  <currentType.icon
                    className={`w-4 h-4 ${currentType.color}`}
                  />
                </div>
              ...
              <div className="p-3 bg-muted/50 rounded-lg text-sm">
                {novelTitle && (
                  <p className="text-muted-foreground">
                    Truyện:{" "}
                    <span className="text-foreground">{novelTitle}</span>
                  </p>
                )}
                {chapterTitle && (
            ...
            <div className="space-y-2">
              ...
              <input
                ...
                className="w-full px-4 py-3 rounded-lg bg-background border border-input text-foreground placeholder:text-muted-foreground focus:border-primary focus:ring-2 focus:ring-primary/20 outline-none transition-all"
                maxLength={200}
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <textarea
                ...
                rows={5}
                className="w-full px-4 py-3 rounded-lg bg-background border border-input text-foreground placeholder:text-muted-foreground focus:border-primary focus:ring-2 focus:ring-primary/20 outline-none transition-all resize-none"
                maxLength={5000}
              />
            </div>
            ...
            <div className="flex gap-3 pt-2">
              <button
                onClick={reset}
                disabled={isPending}
                className="flex-1 px-4 py-2.5 bg-muted text-muted-foreground rounded-lg hover:bg-muted/80 transition-colors disabled:opacity-50"
              >
                Hủy
              </button>
              <button
                ...
                className="flex-1 px-4 py-2.5 bg-primary text-primary-foreground font-medium rounded-lg hover:bg-primary/90 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
              >
                {isPending ? (
                  <>
