            ...
            <div className="flex items-center justify-between mb-3">
                ...
                {!isOpen && (
                    <button
                        ...
                        className="flex items-center gap-2 px-5 py-2.5 bg-amber-500 text-white font-bold rounded-lg hover:bg-amber-600 transition-all"
                    >
                ...
                <div className="mt-4 space-y-3 animate-in slide-in-from-top-2">
                    <div>
                        ...
                        <textarea
                            ...
                            rows={3}
                            className="w-full px-4 py-3 bg-white border border-amber-200 rounded-lg text-foreground placeholder:text-gray-400 focus:border-amber-500 focus:ring-2 focus:ring-amber-500/20 outline-none transition-all resize-none"
                            disabled={isPending}
                        />
                    </div>
                    <div className="flex justify-end gap-3">
                        ...
                        <button
                            ...
                            disabled={isPending}
                            className="flex items-center gap-2 px-5 py-2.5 bg-amber-500 text-white font-bold rounded-lg hover:bg-amber-600 transition-all disabled:opacity-50"
                        >
                            {isPending ? (
