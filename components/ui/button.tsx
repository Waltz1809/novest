  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        outline:
          "border border-gray-400 bg-transparent shadow-sm hover:bg-gray-400 hover:text-white",
        secondary:
      ...
      size: {
        ...
        sm: "rounded-full px-3 py-2.5 text-xs",
        md: "rounded-full px-4 py-2.5 text-sm",
        lg: "rounded-full sm:px-6 sm:py-2.5 px-3 py-2 sm:text-lg",
        icon: "md:size-12 size-10 rounded-md",
      },
    },
    defaultVariants: {
      variant: "default",
