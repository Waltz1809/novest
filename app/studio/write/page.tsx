  ...
  const handleCreateVolume = async (e: React.FormEvent) => {
    ...
    startVolumeTransition(async () => {
      ...
      if (res.error) {
        ...
        const createdVol = vols.find(
          (v) => v.order === newVolumeOrder && v.title === newVolumeTitle
        );
        if (createdVol) {
      ...
      <div className="mb-6 flex items-center justify-between">
        <div>
          ...
          <p className="text-[#9CA3AF] text-sm">
            Soạn thảo và đăng tải chương mới cho truyện.
          </p>
        </div>
        <button
        ...
        <div className="lg:col-span-1 space-y-6 overflow-y-auto pr-1">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex gap-2">
                      <input
                        ...
                        onChange={(e) =>
                          setNewVolumeOrder(parseInt(e.target.value))
                        }
                        placeholder="Thứ tự"
          ...
          <div className="bg-[#1E293B] p-5 rounded-xl shadow-lg border border-[#34D399]/20 space-y-4">
            ...
            <div className="flex items-center gap-3 p-3 bg-[#0B0C10]/50 rounded-lg border border-[#34D399]/10">
              ...
              <label
                htmlFor="isLocked"
                className="text-sm font-medium text-white select-none cursor-pointer flex items-center gap-1.5"
              >
                <Lock className="w-3.5 h-3.5 text-[#9CA3AF]" /> Khóa chương
                (VIP)
              </label>
            </div>
