...
import { checkAdminAuth, unauthorizedResponse, safeParseInt, isValidEnum, VALID_APPROVAL_STATUSES } from "@/lib/api-utils";
...
export async function GET(request: NextRequest) {
    try {
        ...
        if (isValidEnum(status, VALID_APPROVAL_STATUSES)) {
